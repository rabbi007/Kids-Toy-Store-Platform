        ...
        {highRatedToys.map((toy) => (
          ...
          >
            ...
            <div>
              ...
              {/* Description */}
              <p className="text-sm text-gray-500 mb-3">{toy.description.slice(0, 100)}...</p>
              ...
              <div className="text-right">
                <a
                  ...
                  className="inline-block bg-[#FF6347] text-white py-2 px-4 rounded-lg hover:bg-[#FF4500] hover:underline text-center transition duration-300 ml-auto"
                >
                  View Details
                </a>
              </div>
