            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <div className="flex items-center">
                <img
                  src="/logo.png"
                  alt="ToyPark Logo"
                  className="h-10 w-10 sm:h-12 sm:w-12 md:h-16 md:w-16 object-contain mr-2"
                />
                <Link
                  to="/"
            ...
            <div className="flex items-center">
              <div className="hidden sm:flex items-center gap-3">
                {currentUser ? (
                  ...
                  <Link
                    to="/login"
                    className="btn btn-ghost text-base sm:text-lg text-white transition-all duration-300 hover:bg-gray-800 hover:text-blue-400"
                  >
                ...
                {currentUser && (
                  <button
                    className="btn btn-ghost text-base sm:text-lg text-white transition-all duration-300 hover:bg-gray-800 hover:text-red-500"
